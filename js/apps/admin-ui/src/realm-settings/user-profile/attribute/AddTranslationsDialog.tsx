...
export const AddTranslationsDialog = ({
    ...
    const fetchLocalizationTexts = async () => {
      try {
        ...
        const translations = results.map((result, index) => {
          ...
          const formattedTranslationKey = translationKey.substring(
            2,
  ...
  }, [combinedLocales, realmName, translationKey]);
  ...
  }, [combinedLocales, defaultTranslations, setValue, translationKey]);
