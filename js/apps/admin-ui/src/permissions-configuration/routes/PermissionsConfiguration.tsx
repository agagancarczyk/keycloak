...
const PermissionsConfigurationSection = lazy(() => import("../PermissionsConfigurationSection"));
...
export const toPermissionsConfiguration = (params: PermissionsConfigurationParams): Partial<Path> => ({
