...
export type NewPermissionConfigurationParams = { realm: string; resourceType: string };
...
export const NewPermissionConfigurationRoute: AppRouteObject = {
  path: "/:realm/permissions/permission/new/:resourceType",
...
export const toCreatePermissionConfiguration = (params: NewPermissionConfigurationParams): Partial<Path> => ({
