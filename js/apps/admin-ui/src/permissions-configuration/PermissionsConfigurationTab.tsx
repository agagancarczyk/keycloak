...
export const PermissionsConfigurationTab = ({
  ...
  const [resourceTypes, setResourceTypes] = useState<ResourceServerRepresentation>();
        ...
        <PaginatingTableToolbar
          ...
          toolbarItem={
            <>
              <ToolbarItem>
                <SearchDropdown
                  types={resourceTypes?.authorizationSchema?.resourceTypes}
                  resources={[]}
                  scopes={[]}
                  policies={[]}
                  search={search}
              ...
              <ToolbarItem>
                <Button
                  ...
                  onSelect={(resourceType) =>
                    navigate(
                     toCreatePermissionConfiguration({ realm, resourceType: resourceType.type! }),
                    )
                  }
